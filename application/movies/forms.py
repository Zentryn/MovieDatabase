...
class MovieForm(FlaskForm):
    ...
    poster_url = StringField("Poster URL", [validators.Regexp("^.*jpg|.*png$", message="URL has to an image."), validators.Length(min=5, max=255)], id="input-poster", render_kw={"placeholder": "Poster URL"})
